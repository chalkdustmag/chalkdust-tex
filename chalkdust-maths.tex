...
\verb@chalkdust-maths@ is a package for \LaTeX{} that provides common mathematical commands.
To use it, put \verb@\usepackage{chalkdust-maths}@ at the top of your LaTeX file,
or put \verb@\usepackage[xetex]{chalkdust-maths}@ at the top of your XeLaTeX file.

\section{Options}
You can pass the following options into the \verb@chalkdust-maths@ package:

\begin{tabular}{|l|l|}
    \hline
    Option&Description\\
    \hline
    \verb@words@&Use words instead of symbols for grad and curl\\\hline
    \verb@xetex@&Put package in XeTeX mode\\\hline
\end{tabular}
